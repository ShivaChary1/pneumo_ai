...
const Footer = () => {
  return (
    ...
    <footer className="bg-white z-30">
  <div className="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <img src={logo} alt="" />
        <p className="max-w-md mx-auto mt-6 leading-relaxed text-gray-400 sm:max-w-xs sm:mx-0 sm:text-left">
        </p>
        ...
        <div className="text-center sm:text-left">
          ...
          <nav className="mt-8">
            <ul className="space-y-4 text-sm">
              <li>
                <a className="text-gray-800 transition hover:text-gray-800/75" href="/">
                  Company History
                </a>
              </li>
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span className="text-gray-800 transition group-hover:text-gray-800/75">
                  pneumo.ai@gmail.com
                </span>
              </a>
            </li>
            ...
            >
              ...
              {' '}
              <address className="mt-0.5 not-italic -ml-2 text-gray-800">
                Hyderabad, India.
              </address>
            </li>
          </ul>
