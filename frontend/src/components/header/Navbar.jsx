      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <Popover.Button className="nav-new flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
              Services
                  ...
                  {products.map((item) => (
                    ...
                    >
                      <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                        <item.icon className="h-6 w-6 text-indigo-600 group-hover:text-indigo-600" aria-hidden="true" />
                      </div>
                      <div className="flex-auto">
                        <a href={item.href} className="block font-semibold text-indigo-600">
                          {item.name}
          ...
          <a href="#whyus" className="nav-new text-sm font-semibold leading-6 text-gray-900">
            Why Us?
          </a>
          <a href="#pneumonia" className="nav-new text-sm font-semibold leading-6 text-gray-900">
            Symptoms
          </a>
          <a href="#causes" className="nav-new text-sm font-semibold leading-6 text-gray-900">
            Causes
          </a>
        </Popover.Group>
